          ...
          {weeklyData.map((day, idx) => (
            <div key={idx} className="flex flex-col items-center flex-1 group">
              ...
              <div className="w-6 sm:w-8 bg-slate-100/80 rounded-t-lg overflow-hidden h-28 flex items-end">
                <div
                  className="w-full bg-linear-to-t from-primary to-emerald-400 rounded-t-lg transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)] origin-bottom"
                  style={{
