      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-emerald-900/15">
          <div className="flex items-center gap-3">
            <div
              className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 grid place-items-center text-white text-sm font-bold shadow-lg shadow-emerald-900/30 animate-float"
        ...
        <div className="px-3 pb-4 pt-2 border-t border-emerald-900/15">
          <button
            ...
            className="group flex items-center gap-3 rounded-xl px-3 py-2.5 w-full
                            bg-white/[0.03] border border-emerald-500/6
          ...
          <div className="relative z-10 w-full max-w-sm mx-4 rounded-2xl overflow-hidden shadow-2xl animate-scaleIn">
            ...
            <div className="bg-[#0d1f14] border border-white/[0.07] px-7 py-7">
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowLogoutModal(false)}
                  className="flex-1 py-2.5 rounded-xl border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 hover:text-white text-sm font-semibold transition-all duration-200"
                >
                  {t("cancel") || "Cancel"}
                </button>
                <button
                  onClick={confirmLogout}
                  className="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white text-sm font-bold shadow-md hover:shadow-red-500/30 transition-all duration-200"
                >
                  {t("logout")}
                </button>
              </div>
