...
export default function CityMap({ reports, bins }) {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div
        className={`absolute top-3 ${document.documentElement.dir === "rtl" ? "left-3" : "right-3"} 
        ...
        <button
          ...
          ${mapMode === "satellite" ? "bg-primary text-white shadow-sm" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100"}`}>
