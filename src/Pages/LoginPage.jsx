...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center relative px-4 sm:px-6 lg:px-8"
      style={{ backgroundImage: `url(${bg})` }}>
      {/* Animated overlay */}
      <div className="absolute inset-0 bg-linear-to-br from-black/60 via-emerald-950/30 to-black/70" />
      {/* Floating decorative shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[15%] left-[10%] h-32 w-32 rounded-full bg-emerald-500/5 animate-float"
        style={{ animationDuration: "5s" }}/>
        <div
          className="absolute top-[60%] right-[15%] h-24 w-24 rounded-full bg-emerald-400/5 animate-float"
          style={{ animationDuration: "7s", animationDelay: "1s" }}
        />
        <div className="absolute bottom-[20%] left-[30%] h-16 w-16 rounded-full bg-emerald-300/5 animate-float"
      ...
      <div className="relative w-full max-w-md animate-scaleIn">
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          {/* Top gradient bar */}
          <div className="h-1.5 bg-linear-to-r from-emerald-500 via-primary to-emerald-600" />
          <div className="glass-card-strong p-7 sm:p-8">
            ...
            <div className="text-center mb-7">
              <div className="h-14 w-14 rounded-2xl bg-linear-to-br from-emerald-500 to-emerald-700 mx-auto mb-4 flex items-center justify-center shadow-lg shadow-emerald-500/20 animate-float"
              ...
              <p className="text-slate-400 text-sm mt-1">{t("admin_login")}</p>
            </div>
            <form onSubmit={handleSubmit(signIn)} className="space-y-4">
              ...
              <div>
                <div className="relative group">
                  ...
                  <input type="email" placeholder={t("admin_email")}
                  className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all text-sm bg-white/80
                    ${errors.email ? "border-red-300" : "border-slate-200"}`} {...register("email")}/>
                </div>
                {errors.email && (
              ...
              <div>
                <div className="relative group">
                  ...
                  <input type={showPass ? "text" : "password"} placeholder={t("password")}
                    ...
                    ${errors.password ? "border-red-300" : "border-slate-200"}`} {...register("password")}/>
              ...
              className="w-full bg-linear-to-r from-primary to-emerald-600 hover:from-primary-hover hover:to-emerald-700 disabled:opacity-60 text-white py-3 rounded-xl font-bold shadow-md hover:shadow-lg transition-all cursor-pointer flex items-center justify-center gap-2">
                {loading ? (
                  <>
              ...
              <p className="text-center text-sm">
                ...
                className="text-primary hover:text-primary-hover hover:underline font-semibold transition">
                  {t("forgot_password")}
                </Link>
              </p>
