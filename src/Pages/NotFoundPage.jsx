        ...
        >
            ...
            <div className="relative animate-scaleIn">
                <div className="rounded-3xl overflow-hidden shadow-2xl">
                    <div className="h-1.5 bg-gradient-to-r from-amber-400 via-red-400 to-amber-500" />

                    <div className="glass-card-strong w-full max-w-md p-8 text-center">
                        <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 mx-auto mb-5 flex items-center justify-center shadow-lg shadow-emerald-500/20 animate-float" style={{ animationDuration: '4s' }}>
                        ...
                        <Link
                            to="/login"
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-emerald-600 hover:from-primary-hover hover:to-emerald-700 text-white px-6 py-3 rounded-xl font-bold shadow-md hover:shadow-lg transition-all cursor-pointer animate-fadeInUp stagger-4"
                        >
                            <FaHome />
                            Back to Login
                        </Link>
